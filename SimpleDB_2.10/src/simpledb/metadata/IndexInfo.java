...
import simpledb.index.extensiblehash.GlobalDepthIndex;
...
public class IndexInfo {
    ...
    */
   public IndexInfo(String idxname, String tblname, String fldname, String type,
                    Transaction tx) {
	   System.out.println("call indexinfo!");
   ...
   public Index open() {
      ...
      System.out.println("call IndexInfo.open " + this.idxtype);
      ...
      if (this.idxtype.equals("bt")){
    	  ...
    	  return new GlobalDepthIndex(idxname, sch, tx);
      }
   }
