...
public class IndexMgr {
   ...
   public Map<String,IndexInfo> getIndexInfo(String tblname, Transaction tx) {
      ...
      while (rf.next())
         ...
         String tyname = rf.getString("typename");
         IndexInfo ii = new IndexInfo(idxname, tblname, fldname, tyname, tx);
