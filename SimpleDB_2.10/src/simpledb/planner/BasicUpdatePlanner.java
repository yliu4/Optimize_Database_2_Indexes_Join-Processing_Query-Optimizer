...
public class BasicUpdatePlanner implements UpdatePlanner {
   ...
   public int executeCreateIndex(CreateIndexData data, Transaction tx) {
	   System.out.println("call executecreateindex in BasicUpdatePlanner");
      SimpleDB.mdMgr().createIndex(data.indexName(), data.tableName(), data.fieldName(), data.idxType(), tx);
      return 0;  
   }
}
